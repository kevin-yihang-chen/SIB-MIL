...
from BNN.models import ABMIL, DSMIL
from BNN.models.abmil import BClassifier
...
def main():
    ...
    parser.add_argument('--dataset', default='BRACS_WSI', type=str,
                        choices=['Camelyon', 'Unitopatho', 'COAD', 'BRACS_WSI'], help='Dataset folder name')
    ...
    assert args.dataset in ['Camelyon', 'Unitopatho', 'COAD', 'BRACS_WSI'], 'Dataset not supported'
