...
class TransMIL(BaseModel):
    def __init__(self, input_size, n_classes,  layer_type='HS', priors=None, activation_type="relu"):
        super(TransMIL, self).__init__(layer_type=layer_type, priors=priors, activation_type=activation_type)
        self.pos_layer = PPEG(dim=512)
    ...
    def forward(self, h, Train_flag=True, train_sample=1 ,test_sample=1):
        h = h.unsqueeze(0)
        h = self._fc1(h)  # [B, n, 512]
